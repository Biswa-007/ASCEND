...
from app.models import user, project, deployment, deployment_log  # noqa: F401
...
async def run_async_migrations() -> None:
    ...
    print("FINAL URL =", config.get_section(config.config_ini_section, {}).get("sqlalchemy.url"))
